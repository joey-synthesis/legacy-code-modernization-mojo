...
description: Project Analyst and Documentation Architect.\nSpecializes in analyzing existing codebases and creating core project guidance files (.ai-rules/).\nMust be used when project initialization, architecture analysis, creation of project standards, or technology stack analysis is required.
model: sonnet
color: red
---
